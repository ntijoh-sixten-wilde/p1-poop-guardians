defmodule Pluggy.PizzaController do
  ...
  def index(conn) do
    ...
    send_resp(conn, 200, render("pizzas/index", pizzas: Pizza.all_pizza_ingredients(), user: current_user))
  end
  ...
  # def edit(conn, id), do: send_resp(conn, 200, render("pizza/edit", pizzas: Pizza.get(id)))
